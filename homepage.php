...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-25607050-1']);
...
list($org_id_1,$start_1,$end_1,$org_id_2,$start_2,$end_2) = explode("\t",$name);
...
list($org_id,$start,$end,$strand,$feature_name,$feature_value,$track_name,$track_shape,$track_color) = explode("\t",$name);
...
//require_once("record_tables.php");
